...
function createMap(data_p,data_pin)
{
    ...
    <div class="postadd">
    <ul>
        <li>Name: ${data_pin[0].PostOffice[0].Name}</li>
        <li>Branch: ${data_pin[0].PostOffice[0].BranchType}</li>
        <li>Delivery: ${data_pin[0].PostOffice[0].DeliveryStatus}</li>
        <li>Dsitrict: ${data_pin[0].PostOffice[0].District}</li>
        <li>Division: ${data_pin[0].PostOffice[0].Division}</li>
    </ul>
    <ul>
        <li>Name: ${data_pin[0].PostOffice[1].Name}</li>
        <li>Branch: ${data_pin[0].PostOffice[1].BranchType}</li>
        <li>Delivery: ${data_pin[0].PostOffice[1].DeliveryStatus}</li>
        <li>Dsitrict: ${data_pin[0].PostOffice[1].District}</li>
        <li>Division: ${data_pin[0].PostOffice[1].Division}</li>
    </ul>
    <ul>
        <li>Name: ${data_pin[0].PostOffice[2].Name}</li>
        <li>Branch: ${data_pin[0].PostOffice[2].BranchType}</li>
        <li>Delivery: ${data_pin[0].PostOffice[2].DeliveryStatus}</li>
        <li>Dsitrict: ${data_pin[0].PostOffice[2].District}</li>
        <li>Division: ${data_pin[0].PostOffice[2].Division}</li>
    </ul>
    <ul>
        <li>Name: ${data_pin[0].PostOffice[3].Name}</li>
        <li>Branch: ${data_pin[0].PostOffice[3].BranchType}</li>
        <li>Delivery: ${data_pin[0].PostOffice[3].DeliveryStatus}</li>
        <li>Dsitrict: ${data_pin[0].PostOffice[3].District}</li>
        <li>Division: ${data_pin[0].PostOffice[3].Division}</li>
    </ul>
    </div>`
